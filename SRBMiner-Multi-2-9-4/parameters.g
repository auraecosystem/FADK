...
--algorithm-cpu value           (cpu-only algorithm/s, separate values with ;)
...
--autotune-no-load              (disable automatic save/load of GPU autotune results)
...
: Separate algorithms with ; and values inside an algorithm with ,
: Use either --algorithm or the pair --algorithm-gpu/--algorithm-cpu
...
http://127.0.0.1:3333/stats

Or the json : https://127.0.0.1:21550
